...
class ParticipantListPage  : Fragment() {
    override fun onCreateView(
        ...
        binding.recylerView.adapter = ParticipantAdapter(getParticipants())
        /*val view = inflater.inflate(R.layout.service_list_recyclerview_layout, container, false)
        view.recylerView.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        view.recylerView.adapter = ParticipantAdapter(getParticipants())*/

        return binding.root
    }
    private fun getParticipants(): MutableList<StudentModel> {
